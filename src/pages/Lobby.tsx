...
const maps = [
  { mode: 'campaign' as GameMode, title: 'DSA Campaign', description: 'Ranked progression' },
  { mode: 'duel' as GameMode, title: 'Clash Code', description: 'Competitive battlefield' },
  { mode: 'practice' as GameMode, title: 'Practice Lab', description: 'Unranked sandbox' },
];
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-30 bg-primary text-primary-foreground px-4 py-3 rounded-full font-semibold flex items-center gap-2 shadow-lg hover:scale-105 transition-transform"
      >
        <Users size={18} />
        Friends
      </button>
      ...
      <main className="pt-[70px] md:pl-[250px] min-h-screen p-4 md:p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Competitive coding arena</p>
        </div>
        ...
        <section className="glass-panel p-5 mb-6">
          ...
          <div className="w-full h-[250px] md:h-[300px] bg-black/30 rounded-lg overflow-hidden mb-3">
            <iframe
              ...
              src="https://sketchfab.com/models/0fda28d637324d5694493bd2e0d6d071/embed?autospin=0.2&autostart=1&ui_theme=dark&ui_controls=0&ui_hint=0&camera=0&dnt=1"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {maps.map((map) => (
              <MapCard
                ...
                onClick={() => setSelectedMode(map.mode)}
              />
            ))}
          </div>
        </section>
